...
def update_xml_to_db(input_file, db_file):
    ...
    table_name = 'VICTORYreg'
    create_table_query = f"CREATE TABLE IF NOT EXISTS {table_name} (PriceUpdateDate TEXT, ItemCode TEXT PRIMARY KEY, ItemType TEXT, ItemName TEXT, ManufactureName TEXT, ManufactureCountry TEXT, ManufactureItemDescription TEXT, UnitQty TEXT, Quantity TEXT, UnitMeasure TEXT, BisWeighted TEXT, QtyInPackage TEXT, ItemPrice TEXT, UnitOfMeasurePrice TEXT, AllowDiscount TEXT, itemStatus TEXT, LastUpdateDate TEXT, LastUpdateTime TEXT);"
...
# Example usage:
process_folder(r'C:\Users\elior\PycharmProjects\priceses\Victory.XML\VictoryREG', 'priceDB.db')
